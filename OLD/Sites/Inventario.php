...
<div class='well well-lg'>
    ...
    <a type='button' class='btn btn-info' data-toggle='collapse' data-target='#ChangeAProduct'>Change a Price</a>
    <div id='ChangeAProduct' class='collapse row' style='width:90%'>
        <p>to change a prince, insert the ID, then the new Price</p>
    </div>
    <table>
        <tr>
            <th>Id</th>
